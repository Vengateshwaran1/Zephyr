...
const PREVIEW_MESSAGES = [
  { id: 1, content: "Hey! Hii how are you?", isSent: false },
  {
    id: 2,
    content: "I'm fine!.",
    isSent: true,
  ...
  return (
    <div className="h-screen container mx-auto px-4 pt-20 max-w-5xl">
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-3 gap-2 bg-base-300 rounded-full">
          {THEMES.map((t) => (
            <button
              key={t}
              ...
              <div className="bg-base-100 rounded-xl shadow-sm overflow-hidden">
                <div className="px-4 py-3 border-b border-base-300 bg-base-100">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="font-medium text-sm">Vengateshwaran K</h3>
                ...
                <div className="p-4 border-t border-base-300 bg-base-100">
                  <div className="flex gap-2">
                    <input
                      ...
                      readOnly
                    />
                    <button className="btn btn-accent h-10 min-h-0 rounded-badge">
                      <Send size={18} />
                    </button>
                  </div>
                </div>
